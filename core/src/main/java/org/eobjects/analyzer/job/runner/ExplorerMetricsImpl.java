...
final class ExplorerMetricsImpl implements ExplorerMetrics {

	private final AnalysisJobMetrics _analysisJobMetrics;
	private final ExplorerJob _explorerJob;

	public ExplorerMetricsImpl(AnalysisJobMetrics analysisJobMetrics, ExplorerJob explorerJob) {
		_analysisJobMetrics = analysisJobMetrics;
		_explorerJob = explorerJob;
	}

	@Override
	public ExplorerJob getExplorerJob() {
		return _explorerJob;
	}
