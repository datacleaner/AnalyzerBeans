...
public class StringAnalyzerTest extends TestCase {
	...
	public void testTypicalExample() throws Exception {
		...
		assertEquals("Lowercase chars                 13        31 ", resultLines[13]);
		assertEquals("Digit chars                      0         0 ", resultLines[14]);
		assertEquals("Diacritic chars                  0         0 ", resultLines[15]);
		assertEquals("Non-letter chars                 0         1 ", resultLines[16]);
		assertEquals("Word count                       4         5 ", resultLines[17]);
		assertEquals("Max words                        1         2 ", resultLines[18]);
		assertEquals("Min words                        1         1 ", resultLines[19]);
	}
	...
	public void testOddValuesWithMoreThanOneDistinctCount() throws Exception {
		...
		assertEquals("Total char count                62        30 ", resultLines[5]);
		assertEquals("Max chars                        9        12 ", resultLines[6]);
		assertEquals("Min chars                        5         2 ", resultLines[7]);
		assertEquals("Avg chars                     6,25         6 ", resultLines[8]);
		assertEquals("Max white spaces                 1         2 ", resultLines[9]);
		assertEquals("Min white spaces                 0         0 ", resultLines[10]);
		assertEquals("Avg white spaces              0,25         1 ", resultLines[11]);
		assertEquals("Uppercase chars                 58         0 ", resultLines[12]);
		assertEquals("Lowercase chars                  0        19 ", resultLines[13]);
		assertEquals("Digit chars                      0         0 ", resultLines[14]);
		assertEquals("Diacritic chars                  9         0 ", resultLines[15]);
		assertEquals("Non-letter chars                 4        11 ", resultLines[16]);
		assertEquals("Word count                      13         9 ", resultLines[17]);
		assertEquals("Max words                        2         2 ", resultLines[18]);
		assertEquals("Min words                        1         0 ", resultLines[19]);
	}
	...
	public void testNoRows() throws Exception {
		...
		assertEquals("Lowercase chars                  0         0 ", resultLines[13]);
		assertEquals("Digit chars                      0         0 ", resultLines[14]);
		assertEquals("Diacritic chars                  0         0 ", resultLines[15]);
		assertEquals("Non-letter chars                 0         0 ", resultLines[16]);
		assertEquals("Word count                       0         0 ", resultLines[17]);
		assertEquals("Max words                   <null>    <null> ", resultLines[18]);
		assertEquals("Min words                   <null>    <null> ", resultLines[19]);
	}
}
