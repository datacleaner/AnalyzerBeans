...
public class CrosstabRendererTest extends TestCase {
    ...
    public void testOneDimension() throws Exception {
        ...
        String result = crosstabRenderer.render(new HtmlCrosstabRendererCallback(null)).getBodyElements().get(0).toHtml();
        assertEquals("<table class='crosstabTable'><tr><td>EU</td><td>USA</td><td>Asia</td></tr>"
                + "<tr><td>1</td><td>2</td><td>3</td></tr></table>", result.replaceAll("\"", "'"));

        crosstabRenderer.makeVertical(c.getDimension(0));
        result = crosstabRenderer.render(new HtmlCrosstabRendererCallback(null)).getBodyElements().get(0).toHtml();
        assertEquals("<table class='crosstabTable'><tr><td>EU</td><td>1</td></tr>" + "<tr><td>USA</td><td>2</td></tr>"
