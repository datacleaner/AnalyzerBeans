...
public class ValueDistributionResultHtmlRendererTest extends TestCase {
	...
	public void testSingleDistribution() throws Exception {
		...
		String html = new ValueDistributionResultHtmlRenderer().render(result);
		assertEquals(
				FileHelper.readFileAsString(new File("src/test/resources/value_distribution_result_html_renderer_single.html")),
				html);
	}
