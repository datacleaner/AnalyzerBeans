...
public class AnalysisJobBuilder {
	...
	public TransformerJobBuilder addTransformer(TransformerBeanDescriptor descriptor) {
		return new TransformerJobBuilder(descriptor,transformedColumnIdGenerator, this);
	}
}