...
public class SortMergeWriterTest extends TestCase {
	...
	public void testDedupArray() throws Exception {
		...
		File file = sorter.write("target/arrays-deduped.csv");
	...
	public void testNullSafety() throws Exception {
		SortMergeWriter<String, Writer> sorter = new SortMergeWriter<String, Writer>(2, ToStringComparator.getComparator()) {
		...
		File file = sorter.write("target/null_safety.txt");
		assertTrue(file.exists());
	...
	public void testNoUnnescesaryTempFiles() throws Exception {
		SortMergeWriter<String, Writer> sorter = new SortMergeWriter<String, Writer>(10, ToStringComparator.getComparator()) {
		...
		File file = sorter.write("target/no_temp_file.txt");
		assertTrue(file.exists());
	...
	private void doSortTests(int threshold) throws Exception {
		...
		sorter.append("11");
		sorter.append("14");
		File file = sorter.write("target/sort_" + threshold + ".txt");
	...
	private void doDedupTests(int threshold) throws Exception {
		...
		sorter.append("10");
		sorter.append("10");
		File file = sorter.write("target/dedup_" + threshold + ".txt");
