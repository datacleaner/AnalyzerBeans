...
/**
 * Annotation that marks a method as the @Run method of an AnalyzerBean. A @Run
 ...
 * AnalyzerBeans)</li>
 * <li>The Row to be processed (required for ROW_PROCESSING type AnalyzerBeans)</li>
 * <li>Long which will represent the distinct count of the row (optional for
 * ROW_PROCESSING type AnalyzerBeans)</li>
 * <li>
 * </ul>
 */
